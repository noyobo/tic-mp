...
!(function(a, b) {
  ...
  function X(a, b) {
    ...
    return 'string' == typeof b && ((b = a.localeData().monthsParse(b)), 'number' != typeof b)
      ? a
      : ((c = Math.min(a.date(), T(a.year(), b))), a._d['set' + (a._isUTC ? 'UTC' : '') + 'Month'](b, c), a);
  }
  function Y(b) {
    ...
    return (
      ...
      null === b || (void 0 === e && '' === b)
        ...
        : ('string' == typeof b && (a._i = b = a._locale.preparse(b)),
          o(b) ? new n($(b)) : (c(e) ? xa(a) : e ? va(a) : d(b) ? (a._d = b) : Ba(a), a))
    );
  }
  function Ba(b) {
    var f = b._i;
  ...
  function Ya(a, b) {
    ...
    return (
      Ia(a)
        ...
        : (h = yd.exec(a))
        ? ((c = '-' === h[1] ? -1 : 1),
          (g = { y: 0, d: q(h[hd]) * c, h: q(h[id]) * c, m: q(h[jd]) * c, s: q(h[kd]) * c, ms: q(h[ld]) * c }))
        : (h = zd.exec(a))
        ? ((c = '-' === h[1] ? -1 : 1),
          (g = {
            y: Za(h[2], c),
        ...
        : 'object' == typeof g &&
          ('from' in g || 'to' in g) &&
          ((e = _a(Da(g.from), Da(g.to))), (g = {}), (g.ms = e.milliseconds), (g.M = e.months)),
      (d = new Ha(g)),
  ...
  function ab(a, b) {
    return function(c, d) {
      ...
      return (
        null === d ||
          isNaN(+d) ||
          (ba(b, 'moment().' + b + '(period, number) is deprecated. Please use moment().' + b + '(number, period).'),
          (f = c),
          (c = d),
          (d = f)),
  ...
  function ib(a, b, c) {
    ...
    return (
      ...
      'year' === b || 'month' === b || 'quarter' === b
        ? ((e = jb(this, f)), 'quarter' === b ? (e /= 3) : 'year' === b && (e /= 12))
        : ((d = this - f),
          (e =
            'second' === b
              ? d / 1e3
