...
Component({
  ...
  methods: {
    ...
    sendTextMessage(userId, text, callback) {
      webimComponent.sendC2CTextMessage(
        userId,
        text,
        () => {
          callback &&
    ...
    sendCustomMessage(userId, data, callback) {
      webimComponent.sendC2CCustomMessage(
        userId,
        data,
        () => {
          callback &&
    ...
    sendGroupTextMessage(text, callback) {
      webimComponent.sendGroupTextMessage(
        text,
        () => {
          callback &&
            callback({
    ...
    sendGroupCustomMessage(data, callback) {
      webimComponent.sendGroupCustomMessage(
        data,
        () => {
          callback &&
            callback({
